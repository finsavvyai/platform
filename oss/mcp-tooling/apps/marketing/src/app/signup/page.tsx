...
import { Cpu, UserPlus, Shield, Zap, ArrowRight, Check } from 'lucide-react'
...
export default function SignupPage() {
    ...
    const handleSignup = () => {
        // Redirect to Cloudflare Access - it handles both signup and login
        const returnUrl = encodeURIComponent(`${APP_URL}/onboarding`)
        window.location.href = `${CF_ACCESS_LOGIN_URL}?redirect_uri=${returnUrl}`
    }

    const features = [
        'Create unlimited MCP connectors',
            ...
            >
                ...
                <div className="bg-white/5 backdrop-blur-xl rounded-3xl border border-white/10 p-8">
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-gradient-to-r from-purple-500 to-blue-600 rounded-xl text-white font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all flex items-center justify-center gap-3 group"
                    >
                    ...
                    <div className="mt-3 flex items-center justify-center gap-6 text-gray-500">
                    ...
                    <div className="mt-8 pt-6 border-t border-white/10 space-y-3">
                        <div className="flex items-center gap-3 text-sm text-gray-400">
                            ...
                            <span>Start building in under 60 seconds</span>
                        </div>
                        <div className="flex items-center gap-3 text-sm text-gray-400">
                            <Shield className="w-4 h-4 text-green-400" />
