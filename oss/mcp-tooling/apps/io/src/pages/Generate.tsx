...
import { GenerateRequest, AuthMode } from '../types/database';
        ...
        <div>
          ...
          <div className="flex gap-4 mb-4">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg border-2 transition-all ${uploadMethod === 'file'
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg border-2 transition-all ${uploadMethod === 'url'
                  ? 'border-gray-900 bg-gray-50'
                  : 'border-gray-200 hover:border-gray-300'
                }`}
            >
