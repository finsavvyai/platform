        ...
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            anchor.addEventListener('click', function (e) {
                ...
                if (target) {
                    ...
                    if (targetId === 'pricing') {
                        alert('Pricing section coming soon! Contact us for enterprise pricing.');
                    } else if (targetId === 'docs') {
                        window.open('https://docs.mcpoverflow.com', '_blank');
                    } else if (targetId === 'contact') {
                        alert('Contact us at: hello@mcpoverflow.com');
                    } else if (targetId === 'generate') {
                        document.querySelector('.hero').scrollIntoView({
                            behavior: 'smooth'
                        });
                    } else if (targetId === 'demo') {
                        alert('Live demo coming soon! Try our API endpoints: /api/generate and /api/voice');
                    }
                }
            });
        });
