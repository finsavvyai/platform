...
/**
 * Service for interacting with package managers (npm, yarn, pnpm, bun).
...
export class PackageManagerService {
  ...
  private buildAuditArgs(
    ...
    } else if (packageManager === PACKAGE_MANAGERS.BUN) {
      // Bun doesn't have a native audit command; fallback gracefully
      console.warn('Bun audit not natively supported, using npm audit as fallback');
    }
