...
New to the project? Look for issues labeled [`good first issue`](https://github.com/shacharsol/js-package-manager-mcp/labels/good%20first%20issue). These are great entry points:

- Add unit tests for existing tools
- Improve error messages for common failure modes
- Add examples to documentation
- Fix typos or improve README clarity

## 🎯 Areas for Contribution

### High Priority

- **Bun support improvements**: Enhance Bun-specific features and edge cases
