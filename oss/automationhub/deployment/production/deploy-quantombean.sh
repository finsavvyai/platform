...
configure_ssl() {
    ...
    kubectl apply -f deployment/production/cert-manager-quantombean.yaml -n ${NAMESPACE}

    # Apply domain-specific ingress
    kubectl apply -f deployment/production/quantombean.io-domain.yaml -n ${NAMESPACE}
...
show_summary() {
    ...
    echo -e "  Domain: ${GREEN}https://quantombean.io${NC}"
    echo -e "  API: ${GREEN}https://api.quantombean.io${NC}"
    echo -e "  App: ${GREEN}https://app.quantombean.io${NC}"
    echo -e "  Dashboard: ${GREEN}https://dashboard.quantombean.io${NC}"
    ...
    echo "  2. Test the application by visiting https://quantombean.io"
