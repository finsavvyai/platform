...
func TestTriggerPipelineError(t *testing.T) {
	...
	if _, err := c.TriggerPipeline(context.Background(), "org", "proj", "wf", "main"); err == nil {
...
func TestListPipelinesError(t *testing.T) {
	...
	if _, err := c.ListPipelines(context.Background(), "org", "proj"); err == nil {
...
func TestGetPipelineRunError(t *testing.T) {
	...
	if _, err := c.GetPipelineRun(context.Background(), "org", "proj", "1"); err == nil {
...
func TestListPipelineRunsError(t *testing.T) {
	...
	if _, err := c.ListPipelineRuns(context.Background(), "org", "proj", 10); err == nil {
