...
func TestRemove(t *testing.T) {
	m := NewManager(newTestLogger())
	_ = m.Add("gh-main", &mockProvider{platform: PlatformGitHub})
...
func TestList(t *testing.T) {
	m := NewManager(newTestLogger())
	_ = m.Add("gh-main", &mockProvider{platform: PlatformGitHub})
	_ = m.Add("gl-cloud", &mockProvider{platform: PlatformGitLab})
	_ = m.Add("bb-team", &mockProvider{platform: PlatformBitbucket})
...
func TestGetByPlatform(t *testing.T) {
	m := NewManager(newTestLogger())
	_ = m.Add("gh-main", &mockProvider{platform: PlatformGitHub})
	_ = m.Add("gh-enterprise", &mockProvider{platform: PlatformGitHub})
	_ = m.Add("gl-cloud", &mockProvider{platform: PlatformGitLab})
...
func TestMultipleConnectionsSamePlatform(t *testing.T) {
	...
	_ = m.Add("gh-personal", &mockProvider{
		platform: PlatformGitHub,
		connectStatus: &ConnectionStatus{
			Connected: true,
			Platform:  PlatformGitHub,
...
func TestTestConnection_ProviderError(t *testing.T) {
	m := NewManager(newTestLogger())
	_ = m.Add("gh-broken", &mockProvider{
		platform:   PlatformGitHub,
...
func TestTestAllConnections_MultiPlatform(t *testing.T) {
	...
	_ = m.Add("gh-enterprise", &mockProvider{
		platform: PlatformGitHub,
		connectStatus: &ConnectionStatus{
			Connected: true,
			Platform:  PlatformGitHub,
