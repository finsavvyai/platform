...
func TestCreateDuplicate(t *testing.T) {
	db := newTestDB(t)
	_ = db.Create(&ConnectionRecord{Name: "gh-main", Platform: "github"})
...
func TestList(t *testing.T) {
	db := newTestDB(t)
	_ = db.Create(&ConnectionRecord{Name: "gh-1", Platform: "github"})
	_ = db.Create(&ConnectionRecord{Name: "gl-1", Platform: "gitlab"})
	_ = db.Create(&ConnectionRecord{Name: "bb-1", Platform: "bitbucket"})
...
func TestListByPlatform(t *testing.T) {
	db := newTestDB(t)
	_ = db.Create(&ConnectionRecord{Name: "gh-1", Platform: "github"})
	_ = db.Create(&ConnectionRecord{Name: "gh-2", Platform: "github"})
	_ = db.Create(&ConnectionRecord{Name: "gl-1", Platform: "gitlab"})
...
func TestUpdate(t *testing.T) {
	db := newTestDB(t)
	_ = db.Create(&ConnectionRecord{Name: "gh-main", Platform: "github", Token: "old"})
...
func TestCount(t *testing.T) {
	...
	_ = db.Create(&ConnectionRecord{Name: "a", Platform: "github"})
	_ = db.Create(&ConnectionRecord{Name: "b", Platform: "gitlab"})
	count, _ = db.Count()
	if count != 2 {
...
func TestPersistenceAcrossReopen(t *testing.T) {
	...
	db1, _ := New(dbPath)
	_ = db1.Create(&ConnectionRecord{Name: "gh-main", Platform: "github", Token: "secret"})
	_ = db1.Close()
...
func TestGetFindingStats(t *testing.T) {
	...
	_ = db.CreateFinding(&FindingRecord{ConnectionName: "c1", RunID: "1", Severity: "critical", Category: "secrets", Title: "t1", Description: "d1", Status: "open"})
	_ = db.CreateFinding(&FindingRecord{ConnectionName: "c1", RunID: "1", Severity: "critical", Category: "secrets", Title: "t2", Description: "d2", Status: "open"})
	_ = db.CreateFinding(&FindingRecord{ConnectionName: "c1", RunID: "1", Severity: "high", Category: "config", Title: "t3", Description: "d3", Status: "open"})
	_ = db.CreateFinding(&FindingRecord{ConnectionName: "c1", RunID: "1", Severity: "low", Category: "config", Title: "t4", Description: "d4", Status: "resolved"})
...
func TestFindingsByConnection(t *testing.T) {
	...
	_ = db.CreateFinding(&FindingRecord{ConnectionName: "gh-main", RunID: "1", Severity: "high", Category: "secrets", Title: "t1", Description: "d1", Status: "open"})
	_ = db.CreateFinding(&FindingRecord{ConnectionName: "gl-prod", RunID: "2", Severity: "low", Category: "config", Title: "t2", Description: "d2", Status: "open"})
