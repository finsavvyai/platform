#!/usr/bin/env python3
# a2a_cli/ui/ui_helpers/panels.py
"""
Rich panel rendering helpers: welcome banner, task details, and artifacts.
"""
import json
...
from a2a_cli.ui.colors import *  # noqa: F401,F403  (border/text/artifact color constants)
