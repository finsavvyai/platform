...
<nav class="nav" class:scrolled aria-label="Main navigation">
	<div class="nav-inner">
		...
		<div class="nav-right">
			<a href="https://api.tenantiq.app/api/auth/login" class="nav-login">Log in</a>
...
{#if menuOpen}
	...
	<div class="mobile-menu" role="dialog" aria-label="Navigation menu">
		...
		<a href="https://api.tenantiq.app/api/auth/login" class="mobile-link" onclick={closeMenu}>Log in</a>
