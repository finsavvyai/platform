			...
			<div class="mt-5 rounded-xl border border-[var(--color-primary)]/30 bg-[var(--color-primary)]/5 p-5">
				<div class="flex items-start gap-3">
					...
					<div class="flex-1">
						...
						<a href="https://api.tenantiq.app/api/auth/onboard-org" class="mt-3 inline-flex min-h-[40px] items-center gap-2 rounded-lg bg-[var(--color-primary)] px-4 py-2 text-xs font-medium text-white hover:shadow-[var(--shadow-md)]">
				...
				<div class="flex items-start gap-3">
					...
					<div class="flex-1">
						...
						<div class="mt-3 flex gap-2">
							<input
								readonly
								value="https://api.tenantiq.app/api/auth/onboard-org"
							...
							<button
								type="button"
								onclick={() => navigator.clipboard?.writeText('https://api.tenantiq.app/api/auth/onboard-org')}
				...
				<div class="mt-3 rounded-xl border border-[var(--color-border)] bg-[var(--color-bg)] p-5">
					<div class="flex items-start gap-3">
						...
						<div class="flex-1">
							...
							<a href="https://api.tenantiq.app/api/auth/login/personal" class="mt-3 inline-flex min-h-[40px] items-center gap-2 rounded-lg border border-[var(--color-border)] px-4 py-2 text-xs font-medium text-[var(--color-text)] hover:bg-[var(--color-bg-secondary)]">
								Sign in to explore
							</a>
						</div>
					</div>
