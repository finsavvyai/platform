<script lang="ts">
	...
	import { API_BASE, LOGIN_URL, LOGIN_PERSONAL_URL } from '$lib/config';
	...
	<div class="hero-inner">
		...
		<div class="right">
			<div class="card">
				...
				<a href="{API_BASE}/auth/login/linkedin" class="btn-li">
				...
				<div class="card-divider"><span>no admin? try demo</span></div>
				<a href="{LOGIN_PERSONAL_URL}" class="btn-onboard">
					Sign in without admin permissions <span class="arrow">→</span>
				</a>
				<p class="onboard-hint">Not a Global Admin? Sign in with limited read-only access to explore the platform.</p>
			</div>
