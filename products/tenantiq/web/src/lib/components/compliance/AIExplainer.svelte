<script lang="ts">
	...
	interface Props { framework: string; controlId: string }
	let { framework, controlId }: Props = $props();
...
<div class="ai-explainer">
	<div class="ai-head">
		<div class="ai-title">
			<Sparkles size={14} />
			<span>AI explanation · {framework}</span>
		</div>
		{#if source}
	...
	{#if loading}
		<div class="ai-loading">
			...
			<span>Analysing {framework} {controlId} + tenant context...</span>
		</div>
	{:else if error}
