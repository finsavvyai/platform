...
export default function PrivacyPolicy() {
  ...
  return (
    <article className="max-w-3xl mx-auto px-6 py-20">
      <h1 className="text-4xl font-bold mb-2 sf-title">{t('privacy.title')}</h1>
      <p className="text-sm mb-12" style={{ color: 'var(--dash-text-secondary)' }}>{t('privacy.last_updated')}</p>
