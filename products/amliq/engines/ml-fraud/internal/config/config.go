...
type BillingConfig struct {
	...
	LemonSqueezy LemonSqueezyConfig `mapstructure:"lemon_squeezy"`
	Stripe       StripeConfig       `mapstructure:"stripe"`
}

// LemonSqueezyConfig contains Lemon Squeezy configuration
type LemonSqueezyConfig struct {
	APIKey        string        `mapstructure:"api_key" validate:"required"`
	StoreID       string        `mapstructure:"store_id" validate:"required"`
...
// StripeConfig contains Stripe configuration
...
type TracingConfig struct {
	...
	Timeout        time.Duration `mapstructure:"timeout" validate:"required"`
	MaxPayloadSize int           `mapstructure:"max_payload_size" json:"max_payload_size" validate:"min=1"`
