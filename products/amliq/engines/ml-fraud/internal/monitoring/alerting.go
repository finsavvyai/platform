...
type AlertRule struct {
	...
	Notifications []AlertNotificationConfig `yaml:"notifications" json:"notifications"`
}
...
type ActiveAlert struct {
	...
	Notifications []AlertNotificationStatus `json:"notifications"`
...
// AlertNotificationConfig defines notification configuration for alerts
...
// AlertNotificationStatus represents notification status for alerts
...
type NotificationSender interface {
	SendAlert(ctx context.Context, alert *ActiveAlert, config AlertNotificationConfig) error
	SendResolved(ctx context.Context, alert *ActiveAlert, config AlertNotificationConfig) error
}
