...
func (p *SlackProvider) Validate(config map[string]interface{}) error { return nil }
...
func (p *EmailProvider) Validate(config map[string]interface{}) error { return nil }
...
func (p *WebhookProvider) Validate(config map[string]interface{}) error { return nil }
...
func (p *PagerDutyProvider) Name() string                                 { return p.name }
func (p *PagerDutyProvider) Type() string                                 { return "pagerduty" }
func (p *PagerDutyProvider) Validate(config map[string]interface{}) error { return nil }
...
func (am *AlertManager) processAlertSample(rule *AlertRule, sample model.Sample) {
	...
	if am.meetsThreshold(float64(sample.Value), rule.Operator, rule.Threshold) {
		// Alert should fire
