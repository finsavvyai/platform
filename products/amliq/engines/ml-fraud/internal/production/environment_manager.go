...
// ManagerConfig holds environment manager configuration
...
type EnvironmentConfig struct {
	...
	Services       []DeploymentServiceConfig `json:"services"`
...
func (em *EnvironmentManager) validateService(ctx context.Context, env Environment, service DeploymentServiceConfig) error {
