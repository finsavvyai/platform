-- Consolidated FinTech Schema - Multi-tenant Architecture (Fixed Version)
-- This schema creates tables in dependency order to avoid foreign key issues

-- ============================================================================
-- SHARED/UTILITY TABLES (no dependencies)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS compliance_us_checks (
    id TEXT PRIMARY KEY,
    organization_id TEXT NOT NULL,
    customer_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS compliance_us_reports (
    id TEXT PRIMARY KEY,
    organization_id TEXT NOT NULL,
    customer_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS compliance_eu_checks (
    id TEXT PRIMARY KEY,
    organization_id TEXT NOT NULL,
    customer_id TEXT NOT NULL,
...
-- Compliance indexes
CREATE INDEX IF NOT EXISTS idx_compliance_us_customers_org_id ON compliance_us_customers(organization_id);
CREATE INDEX IF NOT EXISTS idx_compliance_us_customers_customer_id ON compliance_us_customers(customer_id);
CREATE INDEX IF NOT EXISTS idx_compliance_us_customers_status ON compliance_us_customers(verification_status);
CREATE INDEX IF NOT EXISTS idx_compliance_us_checks_org_id ON compliance_us_checks(organization_id);
CREATE INDEX IF NOT EXISTS idx_compliance_us_checks_customer_id ON compliance_us_checks(customer_id);
CREATE INDEX IF NOT EXISTS idx_compliance_us_checks_type ON compliance_us_checks(check_type);

CREATE INDEX IF NOT EXISTS idx_compliance_eu_customers_org_id ON compliance_eu_customers(organization_id);
CREATE INDEX IF NOT EXISTS idx_compliance_eu_customers_customer_id ON compliance_eu_customers(customer_id);
CREATE INDEX IF NOT EXISTS idx_compliance_eu_customers_status ON compliance_eu_customers(verification_status);
CREATE INDEX IF NOT EXISTS idx_compliance_eu_checks_org_id ON compliance_eu_checks(organization_id);
CREATE INDEX IF NOT EXISTS idx_compliance_eu_checks_customer_id ON compliance_eu_checks(customer_id);
CREATE INDEX IF NOT EXISTS idx_compliance_eu_checks_type ON compliance_eu_checks(check_type);
...
CREATE INDEX IF NOT EXISTS idx_risk_alerts_org_id ON risk_alerts(organization_id);
CREATE INDEX IF NOT EXISTS idx_risk_alerts_assessment_id ON risk_alerts(assessment_id);
