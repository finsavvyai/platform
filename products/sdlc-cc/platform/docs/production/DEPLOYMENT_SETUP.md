...
wrangler route rule update --pattern="sdlc.cc/*" --zone-name="sdlc.cc" --worker="sdlc-platform-dr"
...
curl -v https://api.sdlc.cc/debug -H "Debug-Token: $DEBUG_TOKEN"
