...
// Get active alerts
async function getActiveAlerts(env: Env): Promise<Record<string, unknown>[]> {
...
async function processAnalyticsMessage(message: unknown, env: Env): Promise<void> {
...
async function sendAlertNotification(alert: Record<string, unknown>, env: Env): Promise<void> {
...
async function createAlert(alertData: Record<string, unknown>, env: Env): Promise<void> {
