  ...
  "tests": [
    {
      ...
      "url": "https://api-$env.sdlc.cc/health",
      "method": "GET",
      "frequency": "1m",
    ...
    },
    {
      ...
      "url": "https://api-$env.sdlc.cc/v1/auth/login",
      "method": "POST",
      "frequency": "5m",
      "locations": ["us-east-1"],
      "body": {
    ...
    },
    {
      ...
      "url": "https://api-$env.sdlc.cc/v1/documents",
      "method": "POST",
      "frequency": "10m",
      "locations": ["us-east-1"],
      "headers": {
...
browser_tests:
  ...
  - name: "Login Flow Test"
    url: "https://admin-$env.sdlc.cc/login"
    frequency: "15m"
    locations: ["us-east-1"]
    steps:
      - navigate: "/"
  ...
  - name: "Document Upload Flow Test"
    url: "https://admin-$env.sdlc.cc/documents"
    frequency: "30m"
    locations: ["us-east-1"]
    steps:
      - navigate: "/documents"
