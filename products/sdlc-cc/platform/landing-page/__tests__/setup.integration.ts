...
(global as any).testUtils = {
  ...
  createMockReqRes: (overrides: Record<string, any> = {}) => ({
    req: {
      method: 'GET',
      url: '/',
      headers: {},
    ...
    res: {
      ...
      data: '',
      _getStatusCode: jest.fn(function(this: any) { return this.statusCode; }),
      _getHeaders: jest.fn(function(this: any) { return this.headers; }),
      _getData: jest.fn(function(this: any) { return this.data; }),
      status: jest.fn(function(this: any, code: number) { this.statusCode = code; return this; }),
      json: jest.fn(function(this: any, data: any) { this.data = JSON.stringify(data); return this; }),
      setHeader: jest.fn(function(this: any, name: string, value: string) { this.headers[name] = value; return this; }),
      end: jest.fn(function(this: any, data: any) { this.data = data; return this; }),
      ...overrides.res,
    },
  }),
