...
export class Analytics {
   ...
   */
  async initialize(provider?: AnalyticsProvider): Promise<void> {
   ...
   */
  private async createDefaultProvider(): Promise<AnalyticsProvider | null> {
    try {
   ...
   */
  async track<T extends EventType>(
    eventType: T,
    data: unknown,
    userId?: string
  ): Promise<void> {
   ...
   */
  private async createEvent<T extends EventType>(
    eventType: T,
    data: unknown,
    userId?: string
   ...
   */
  private detectPlatform(): 'web' | 'mobile' | 'api' | 'worker' {
   ...
   * Get page load time
   */
  private getLoadTime(): number | undefined {
   ...
   */
  private shouldTrack(eventType: EventType, data: unknown): boolean {
   ...
   * Add event to queue
   */
  private async addEventToQueue(event: AnalyticsEvent): Promise<void> {
   ...
   */
  async getMetrics(filters?: AnalyticsFilter): Promise<AnalyticsMetrics> {
    if (!this.provider) {
