    ...
    return (<div className={`card ${className}`}>
      ...
      <div className="card-body space-y-4">
        ...
        <div className="space-y-3">
          {services.map((service, index) => (<div key={service.name} className="flex items-center justify-between p-3 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors">
      ...
      <div className="card-footer">
        ...
        }} disabled={loading} className="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 disabled:opacity-50">
...
//# sourceMappingURL=SystemStatusWidget.js.map