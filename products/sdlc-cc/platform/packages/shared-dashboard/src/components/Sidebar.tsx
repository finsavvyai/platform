...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const products: SidebarProduct[] = [
    ...
    },
    {
      ...
      icon: '🤖',
      url: '/rag',
      features: ['Query Processing', 'Context Retrieval', 'Citations'],
    },
    {
      id: 'gateway',
      name: 'API Gateway',
      ...
      icon: '🛡️',
      url: '/gateway',
      features: ['API Gateway', 'Security', 'Rate Limiting'],
    },
    {
      id: 'billing',
      name: 'Billing System',
        ...
        >
          ...
          {!collapsed && (
            <div className="flex items-center space-x-2 flex-shrink-0">
              {item.badge && (
                <span className="inline-flex items-center justify-center w-5 h-5 text-xs font-bold rounded-full bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-300">
                  {item.badge}
                </span>
              )}
              {hasChildren && (
