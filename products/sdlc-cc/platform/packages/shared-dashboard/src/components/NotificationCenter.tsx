  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {open && (
        <div
          ref={dropdownRef}
          className="absolute right-0 mt-2 w-96 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl overflow-hidden z-50"
        >
          {/* Header */}
              ...
              {(['all', 'unread', 'read'] as const).map((filterType) => (
                ...
                >
                  ...
                  {filterType === 'unread' && unreadCount > 0 && (
                    <span className="ml-2 text-xs bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 px-1.5 py-0.5 rounded-full">
                      {unreadCount}
                    </span>
                  )}
                </button>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {notification.actionUrl && (
                          <a
                            ...
                            onClick={() => handleMarkAsRead(notification.id)}
                            className="inline-flex items-center space-x-1 mt-2 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors"
                          >
