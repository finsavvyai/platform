...
type CodeScanResult struct {
	...
	QARecommendations []QARecommendation `json:"recommendations"`
}
...
// QARecommendation represents an improvement recommendation
...
type NotificationRule struct {
	...
	Channels []QANotificationChannel  `json:"channels"`
...
// QANotificationChannel defines notification channels
type QANotificationChannel struct {
...
type AutoReviewSummary struct {
	...
	IssuesByCategory map[string]int `json:"issues_by_category"`
	QualityScore     float64        `json:"quality_score"`
	QARecommendations  []string       `json:"recommendations"`
}
...
// QACache represents pipeline cache
type QACache struct {
	Path  string `json:"path"`
	Key   string `json:"key"`
...
type StageExecution struct {
	...
	Name        string              `json:"name"`
	Status      string              `json:"status"`
	Steps       []QAStepExecution     `json:"steps"`
...
// QAStepExecution represents a step execution
type QAStepExecution struct {
	ID          string              `json:"id"`
	...
	Logs        []QALogEntry          `json:"logs,omitempty"`
...
// QALogEntry represents a log entry
...
type BenchmarkMetrics struct {
	Throughput      []QAMetricPoint            `json:"throughput"`
	ResponseTime    []QAMetricPoint            `json:"response_time"`
	ErrorRate       []QAMetricPoint            `json:"error_rate"`
	CPU             []QAMetricPoint            `json:"cpu"`
	Memory          []QAMetricPoint            `json:"memory"`
	Network         []QAMetricPoint            `json:"network"`
	CustomMetrics   map[string][]QAMetricPoint `json:"custom_metrics,omitempty"`
...
// QAMetricPoint represents a metric data point
type QAMetricPoint struct {
	Timestamp Timestamp         `json:"timestamp"`
...
type ComparisonInsight struct {
	...
	Description    string   `json:"description"`
	Impact         string   `json:"impact"`
	QARecommendation string   `json:"recommendation"`
...
type MetricHistory struct {
	...
	Points   []QAMetricPoint `json:"points"`
...
type AggregatedMetrics struct {
	...
	DataPoints  []QAMetricPoint `json:"data_points"`
...
type DashboardWidget struct {
	...
	Config      QAWidgetConfig  `json:"config"`
	Data        QAWidgetData    `json:"data"`
	Refresh     WidgetRefresh `json:"refresh"`
	Interactive bool          `json:"interactive"`
}

// QAWidgetConfig represents widget configuration
type QAWidgetConfig struct {
	Metric     string                 `json:"metric"`
	Query      string                 `json:"query,omitempty"`
...
// QAWidgetData represents widget data
type QAWidgetData struct {
	Source     string                 `json:"source"`
	Query      string                 `json:"query"`
	RealTime   bool                   `json:"real_time"`
	QACache      int                    `json:"cache_seconds"`
...
type ComplianceOptions struct {
	...
	IncludeQARecommendations bool     `json:"include_recommendations"`
...
type ComplianceValidationResult struct {
	...
	QARecommendations []ComplianceQARecommendation `json:"recommendations"`
...
type ComplianceSummary struct {
	...
	QARiskLevel       string             `json:"risk_level"` // low, medium, high, critical
}
...
// ComplianceQARecommendation represents a compliance recommendation
type ComplianceQARecommendation struct {
	ID          string   `json:"id"`
	Title       string   `json:"title"`
	Description string   `json:"description"`
	Category    string   `json:"category"`
...
// QAComplianceStatus represents compliance status
type QAComplianceStatus struct {
	EntityID       string                    `json:"entity_id"`
	EntityType     string                    `json:"entity_type"`
	...
	QARiskLevel      string                    `json:"risk_level"`
	Metadata       map[string]interface{}    `json:"metadata,omitempty"`
}
...
// QAComplianceReportRequest represents a compliance report request
type QAComplianceReportRequest struct {
...
// QAComplianceReport represents a compliance report
type QAComplianceReport struct {
...
type ReportContent struct {
	...
	QAComplianceOverview QAComplianceOverview         `json:"compliance_overview"`
...
// QAComplianceOverview represents compliance overview
type QAComplianceOverview struct {
...
type RiskMatrix struct {
	Grid   map[string]QARiskLevel `json:"grid"`
	Levels []QARiskLevel          `json:"levels"`
}

// QARiskLevel represents a risk level
type QARiskLevel struct {
	Name        string  `json:"name"`
	Color       string  `json:"color"`
...
type GatePolicy struct {
	...
	UpdatedAt  Timestamp   `json:"updated_at"`
	UpdatedBy  string      `json:"updated_by"`
	Usage      QAPolicyUsage `json:"usage"`
}

// QAPolicyUsage represents policy usage statistics
type QAPolicyUsage struct {
...
type QualityReportContent struct {
	...
	QARecommendations     []QualityQARecommendation   `json:"recommendations"`
...
// QualityQARecommendation represents a quality recommendation
type QualityQARecommendation struct {
	ID                  string     `json:"id"`
	Title               string     `json:"title"`
	Description         string     `json:"description"`
	Category            string     `json:"category"`
