...
// AcceptInvitationRequest represents a request to accept a beta invitation
type AcceptInvitationRequest struct {
	Token string `json:"token"`
}

// RemoveFromProgramRequest represents a request to remove a user from a beta program
type RemoveFromProgramRequest struct {
