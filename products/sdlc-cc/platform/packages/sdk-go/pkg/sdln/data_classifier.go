...
func (dc *DataClassifier) ClassifyEventByType(event *AuditEvent) string {
	...
	contentClassification := dc.classifyByContentPattern(event)
...
func (dc *DataClassifier) classifyByContentPattern(event *AuditEvent) string {
