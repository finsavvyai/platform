...
// NOTE: This WebAuthn implementation references types (protocol.Authenticator,
// protocol.CredentialExtension) that do not exist in go-webauthn/webauthn
// v0.16.4. The file needs a full rewrite against the current API before it
// can be re-enabled. Excluded from the build via the `never` tag until then.
