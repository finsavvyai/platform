...
from ..utils.pagination import handle_pagination, paginate
...
class UsersClient(BaseClient):
    ...
    def update_permissions(
        self, user_id: str, permissions: builtins.list[str], roles: Optional[builtins.list[str]] = None
    ) -> UserPermissions:
        """
