...
-- Note: PostgreSQL CHECK constraints cannot contain subqueries. The
-- following two constraints (super_admin email uniqueness across
-- tenants, file size limits based on subscription tier) require
-- trigger-based enforcement instead. Tracked as a follow-up.
