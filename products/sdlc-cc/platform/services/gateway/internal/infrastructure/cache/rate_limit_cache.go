...
// RedisCache provides a Redis-backed cache (stub implementation using in-memory cache)
type RedisCache struct {
	*RateLimitCache
}

// NewRedisCache creates a new RedisCache
func NewRedisCache(redisClient interface{}, logger *logrus.Logger) *RedisCache {
	return &RedisCache{RateLimitCache: NewRateLimitCache(logger)}
}
