...
// NOTE: Constructor functions are provided by the infrastructure/repositories package.
// Use infrastructure/repositories.NewRepositoryRegistry instead.
func NewRepositoryRegistry(pool *pgxpool.Pool) *RepositoryRegistry {
	// Stub: actual constructors live in infrastructure/repositories
	return &RepositoryRegistry{}
}

// SessionRepository is an alias for UserSessionRepository
