...
impl MetricsService {
    pub fn new() -> Self {
        ...
        registry.register(Box::new(search_total.clone())).unwrap();
        registry.register(Box::new(search_duration.clone())).unwrap();
        registry.register(Box::new(embedding_requests.clone())).unwrap();
        registry.register(Box::new(embedding_duration.clone())).unwrap();
