...
from app.models.schemas import RuleType, ViolationInfo, ViolationSeverity
...
class DLPRuleDefinition:
    ...
    # Rule structure
    conditions: list[RuleCondition | dict[str, Any]]  # Can be nested conditions
...
class RuleExecutionContext:
    ...
    presidio_results: list[Any] | None = None
    regex_results: list[Any] | None = None
    classification_results: list[Any] | None = None
...
class RuleExecutor:
    ...
    def _evaluate_conditions(
        self,
        conditions: list[RuleCondition | dict[str, Any]],
...
class DLPRuleEngine:
    ...
    def get_rule(self, rule_id: str) -> DLPRuleDefinition | None:
        """Get a rule by ID."""
        ...
        stats.update(
            {
                ...
                "rule_types": list({r.rule_type for r in self.rules.values()}),
            }
        )
