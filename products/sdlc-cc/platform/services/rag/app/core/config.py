...
class Settings(BaseSettings):
    ...
    context_packing_enabled: bool = Field(
        default=True, env="CONTEXT_PACKING_ENABLED"
    )
    context_packing_max_tokens: int = Field(
        default=4096, env="CONTEXT_PACKING_MAX_TOKENS"
    )
    context_packing_similarity_threshold: float = Field(
        default=0.9, env="CONTEXT_PACKING_SIMILARITY_THRESHOLD"
    )
    ...
    hybrid_search_rrf_k: int = Field(default=60, env="HYBRID_SEARCH_RRF_K")
