...
class TestTokenManagementIntegration:
    ...
    async def test_complete_token_workflow(
        ...
        await billing_integration.create_customer_account(customer)
    ...
    async def test_budget_exceeded_workflow(
        ...
        # Check for alerts
        await alert_manager.get_active_alerts(tenant_id=tenant_id)
    ...
    async def test_billing_integration_e2e(
        ...
        await billing_integration.create_customer_account(
            free_customer
        )
