...
export const tenantService = {
  ...
  async createTenant(tenantData: Record<string, unknown>) {
    return apiClient.post('/tenants', tenantData)
  },

  async updateTenant(id: string, tenantData: Record<string, unknown>) {
...
export const policyService = {
  ...
  async updatePolicy(id: string, policyData: Record<string, unknown>) {
  ...
  async testPolicy(policyData: Record<string, unknown>, testData: Record<string, unknown>) {
...
export const documentService = {
  ...
  async uploadDocument(file: File, metadata?: Record<string, unknown>, onProgress?: (progress: number) => void) {
    const formData = new FormData()
    formData.append('file', file)
    if (metadata) {
...
export const analyticsService = {
  ...
  async exportReport(type: string, params?: Record<string, unknown>) {
...
export const settingsService = {
  ...
  async createApiKey(keyData: Record<string, unknown>) {
