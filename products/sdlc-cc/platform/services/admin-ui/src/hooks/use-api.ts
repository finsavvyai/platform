...
export function useApi<T = unknown>(url: string | null, options: ApiOptions = {}) {
...
export function usePaginatedApi<T = unknown>(baseUrl: string, options: ApiOptions = {}) {
...
export function useRealTimeApi<T = unknown>(url: string, options: ApiOptions = {}) {
  const [data, setData] = useState<T | null>(null)
