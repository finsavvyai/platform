...
## Roadmap: SDLP integration

Admin UI will host **policy dashboards**, **audit views**, and **LAM (Learning Engine) insights** (e.g. cost and policy recommendations). See [docs/SDLP_INTEGRATION.md](../../docs/SDLP_INTEGRATION.md) for the overall RAG/DLP/OPA/LAM integration plan.
