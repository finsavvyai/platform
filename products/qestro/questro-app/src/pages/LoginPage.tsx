        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              ...
              >
                <svg className="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 0C4.477 0 0 4.477 0 10s4.477 10 10 10 10-4.477 10-10S15.523 0 10 0zm3.7 14.077c-1.75.12-5.652.12-7.402 0C4.727 13.957 4.474 13.018 4.5 10c-.026-3.024.22-3.957 1.798-4.077 1.75-.12 5.652-.12 7.402 0 1.571.12 1.824 1.053 1.8 4.077.026 3.024-.22 3.957-1.8 4.077z" clipRule="evenodd" />
                </svg>
              </button>
            </div>
          </div>
