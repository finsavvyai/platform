...
import { Brain, Sparkles, FileText, Code, Globe, Smartphone, Database, Zap, Download, Copy, Play, Settings, Upload, Lightbulb, Target, Shield } from 'lucide-react';
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setRequest({ ...request, testType: e.target.value as any })}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                    >
                ...
                <div className="px-6 py-4 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button className="flex items-center gap-1 px-3 py-1 text-sm text-white bg-indigo-600 hover:bg-indigo-700 rounded">
