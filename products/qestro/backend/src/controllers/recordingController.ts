...
import { EnhancedRecordingService } from '../services/EnhancedRecordingService.js';
...
// Use enhanced service with AI and real-time sync
let enhancedRecordingService: EnhancedRecordingService;
let recordingService: EnhancedRecordingService;

// Initialize with Socket.IO instance
export const initializeRecordingService = (io: any) => {
  enhancedRecordingService = new EnhancedRecordingService('./recordings', io);
  recordingService = enhancedRecordingService;
};

// Fallback initialization without Socket.IO
if (!enhancedRecordingService) {
  enhancedRecordingService = new EnhancedRecordingService();
  recordingService = enhancedRecordingService;
}

// Export getter for dynamic imports
export const getEnhancedRecordingService = () => enhancedRecordingService;
...
export const stopRecording = async (req: Request, res: Response) => {
  try {
    ...
    // Stop recording (enhanced service returns { session, actions })
    const result = await enhancedRecordingService.stopRecordingWithActions(sessionId);
