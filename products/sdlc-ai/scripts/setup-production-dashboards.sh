...
GRAFANA_URL="${GRAFANA_URL:-https://grafana.sdlc.ai}"
DATADOG_URL="${DATADOG_URL:-https://app.datadoghq.com}"
SENTRY_URL="${SENTRY_URL:-https://sentry.sdlc.ai}"
...
- API Health: ${API_BASE_URL:-https://api.sdlc.ai}/health
- System Status: ${API_BASE_URL:-https://api.sdlc.ai}/api/v1/status

## Alert Configuration
- PagerDuty: Production service configured
- Slack: #alerts-production channel
- Email: alerts@sdlc.ai distribution list
