...
- DNS management access for sdlc.ai domain
...
- **Primary Domain:** api.sdlc.ai
- **Admin Domain:** admin.sdlc.ai
- **DR Domain:** dr.api.sdlc.ai (disaster recovery)
...
curl -v https://api.sdlc.ai/health
...
### Environment URLs
- **Production API:** https://api.sdlc.ai
- **Production Admin:** https://admin.sdlc.ai
- **Monitoring:** https://monitoring.sdlc.ai
- **Status Page:** https://status.sdlc.ai
...
export ALERT_EMAIL=team@sdlc.ai
