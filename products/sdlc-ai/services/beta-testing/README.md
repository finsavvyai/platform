...
# Verify deployment
curl https://beta.sdlc.ai/api/beta/health
```
...
- **Email**: beta-support@sdlc.ai
- **Slack**: #beta-support
- **Documentation**: https://docs.sdlc.ai/beta
- **API Reference**: https://api.sdlc.ai/beta/docs
