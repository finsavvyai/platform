...
describe('DatabaseConnectionManager', () => {
  ...
  describe('Schema Retrieval', () => {
    ...
    it('should retrieve MySQL schema successfully', async () => {
      const mysqlConnection = await connectionManager.createConnection(
        testUtils.createTestConnectionConfig('mysql')
      );
    ...
    it('should retrieve MongoDB schema successfully', async () => {
      const mongoConnection = await connectionManager.createConnection(
        testUtils.createTestConnectionConfig('mongodb')
      );
