...
from app.models.schemas import ViolationInfo, ViolationSeverity, PatternInfo
...
class PatternMatchResult:
    ...
    def __post_init__(self):
        ...
        self.categories_found = list(set(match.category for match in self.matches))
        self.patterns_matched = list(set(match.pattern_name for match in self.matches))
...
class RegexPatternEngine:
    ...
    def get_pattern(self, pattern_name: str) -> Optional[RegexPatternConfig]:
    ...
    def match_text(
        ...
        result = PatternMatchResult(
            ...
            categories_found=list(set(match.category for match in all_matches)),
    ...
    def _get_column_number(self, text: str, position: int) -> Optional[int]:
