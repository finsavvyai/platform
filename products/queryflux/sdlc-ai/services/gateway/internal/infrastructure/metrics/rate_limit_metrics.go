...
// PrometheusMetrics wraps Prometheus metric collectors
...
func NewRateLimitMetricsCollector(config *MetricsConfig, storage MetricsStorage, logger *logrus.Logger) *RateLimitMetricsCollector {
...
func (rmc *RateLimitMetricsCollector) initPrometheusMetrics() *PrometheusMetrics {
