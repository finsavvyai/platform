...
export class QueueManager extends EventEmitter {
  ...
  private async initializeQueues(): Promise<void> {
    ...
    this.documentQueue.process(5, this.processDocumentJob.bind(this));
    this.ocrQueue.process(2, this.processOCRJob.bind(this)); // Less concurrency for OCR
    this.batchQueue.process(1, this.processBatchJob.bind(this)); // Single batch processor
  }
