...
3. **Verify service health:**
   ...
   curl https://api.dr.sdlc.ai/api/v1/status
...
1. **Assessment Phase (2 min):**
   ...
   https://dashboard.sdlc.ai/incidents
...
|------|------|-------|-------|-------|
| Incident Commander | John Doe | +1-555-0100 | john@sdlc.ai | @john |
| Infrastructure Lead | Jane Smith | +1-555-0101 | jane@sdlc.ai | @jane |
| Security Lead | Mike Johnson | +1-555-0102 | mike@sdlc.ai | @mike |
| Database Lead | Sarah Wilson | +1-555-0103 | sarah@sdlc.ai | @sarah |

### Escalation Contacts

| Level | Executive | Phone | Email |
|-------|-----------|-------|-------|
| 1 | Director of Engineering | +1-555-0200 | director@sdlc.ai |
| 2 | VP of Engineering | +1-555-0201 | vp-eng@sdlc.ai |
| 3 | CTO | +1-555-0202 | cto@sdlc.ai |
...
| DNS Provider | dns@sdlc.ai | Network team |
| Security Team | security@sdlc.ai | security@pagerduty.com |
...
# Verify recovery
sleep 10
curl -f https://api.sdlc.ai/health || {
...
Create a comprehensive monitoring dashboard at: https://dashboard.sdlc.ai/dr
