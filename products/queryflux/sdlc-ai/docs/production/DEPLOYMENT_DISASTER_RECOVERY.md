...
curl https://api.sdlc.ai/api/v1/health/db
...
curl -X POST https://api.sdlc.ai/api/v1/auth/force-password-reset \
...
wrangler route rule delete --pattern="test.sdlc.ai/*"
