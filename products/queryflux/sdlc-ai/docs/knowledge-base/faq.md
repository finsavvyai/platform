...
curl -H "Authorization: Bearer your-api-key-here" \
     https://api.sdlc.ai/v3/documents
```
...
- **JavaScript/TypeScript**: npm package `@sdlc.ai/sdk`
...
3. Using the correct endpoint (https://api.sdlc.ai/v3)
...
1. **Check our documentation**: https://docs.sdlc.ai
2. **Search our community forum**: https://community.sdlc.ai
3. **Contact support**: support@sdlc.ai
4. **Schedule a demo**: https://sdlc.ai/demo

### Contact Information
- **Email**: support@sdlc.ai
- **Slack**: https://sdlc.ai/slack
- **Twitter**: @sdlc_ai
