...
- Support portal (https://support.sdlc.ai)
- Email (support@sdlc.ai)
- Slack community (community.sdlc.ai)
...
### Support Team
- **Support Manager**: Sarah Chen (sarah.chen@sdlc.ai)
- **Tier 2 Lead**: Michael Rodriguez (michael.r@sdlc.ai)
- **Enterprise Support**: enterprise@sdlc.ai
- **Critical Issues**: 1-800-SDLC-AI option 1

### Emergency Contacts
- **On-Call Engineer**: Pager: 555-0123
- **Security Incident**: security@sdlc.ai
- **Data Breach**: incident@sdlc.ai
