...
// RetentionManager manages data retention policies and enforcement
...
// DateRange represents a date range for legal holds
...
func (rm *RetentionManager) eventMatchesPolicy(policy *RetentionPolicy, event *AuditEvent) bool {
	if !policy.Enabled {
		return false
	}
...
func (rm *RetentionManager) CreatePolicy(ctx context.Context, policy *RetentionPolicy) error {
...
func (rm *RetentionManager) UpdatePolicy(ctx context.Context, policy *RetentionPolicy) error {
...
func (rm *RetentionManager) DeletePolicy(ctx context.Context, policyID string) error {
...
func (rm *RetentionManager) GetPolicy(ctx context.Context, policyID string) (*RetentionPolicy, error) {
...
func (rm *RetentionManager) ListPolicies(ctx context.Context) []*RetentionPolicy {
...
func (rm *RetentionManager) EnforceRetention(ctx context.Context, tenantID string) error {
	return rm.enforcement.EnforcePolicies(ctx, tenantID, rm.policies)
}

// PlaceLegalHold places a legal hold on data
func (rm *RetentionManager) PlaceLegalHold(ctx context.Context, hold *LegalHold) error {
	return rm.legalHoldMgr.PlaceHold(ctx, hold)
}

// LiftLegalHold lifts a legal hold
func (rm *RetentionManager) LiftLegalHold(ctx context.Context, holdID string, liftedBy string) error {
	return rm.legalHoldMgr.LiftHold(ctx, holdID, liftedBy)
}

// GetRetentionSchedule returns retention rules for a tenant
func (rm *RetentionManager) GetRetentionSchedule(ctx context.Context, tenantID string) ([]RetentionRule, error) {
...
func (re *RetentionEnforcement) EnforcePolicies(ctx context.Context, tenantID string, policies map[string]*RetentionPolicy) error {
	for _, policy := range policies {
		if !policy.Enabled {
			continue
		}
...
func (lhm *LegalHoldManager) PlaceHold(ctx context.Context, hold *LegalHold) error {
	hold.ID = generateID()
...
func (lhm *LegalHoldManager) GetActiveHolds(ctx context.Context, tenantID string) ([]*LegalHold, error) {
	var activeHolds []*LegalHold
...
func (rm *RetentionManager) incrementVersion(version string) string {
