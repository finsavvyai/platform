...
// AnomalyDetector represents ML-based anomaly detection
...
func (m *MonitoringEnhanced) CreateAnomalyDetector(ctx context.Context, tenantID string, req *AnomalyDetectionRequest) (*AnomalyDetector, error) {
...
// GetAnomalyDetector retrieves an anomaly detector
func (m *MonitoringEnhanced) GetAnomalyDetector(ctx context.Context, tenantID, detectorID string) (*AnomalyDetector, error) {
	var detector AnomalyDetector
...
// ListAnomalyDetectors retrieves anomaly detectors
func (m *MonitoringEnhanced) ListAnomalyDetectors(ctx context.Context, tenantID string, opts *ListOptions) (*PaginatedResponse[AnomalyDetector], error) {
	...
	var response PaginatedResponse[AnomalyDetector]
...
// UpdateAnomalyDetector updates an anomaly detector
func (m *MonitoringEnhanced) UpdateAnomalyDetector(ctx context.Context, tenantID, detectorID string, req *AnomalyDetectionRequest) (*AnomalyDetector, error) {
	var detector AnomalyDetector
...
func (m *MonitoringEnhanced) DeleteAnomalyDetector(ctx context.Context, tenantID, detectorID string) error {
...
func (m *MonitoringEnhanced) ListAnomalies(ctx context.Context, tenantID string, opts *AnomalyListOptions) (*PaginatedResponse[Anomaly], error) {
	...
	var response PaginatedResponse[Anomaly]
	err := m.doGet(ctx, path, &response)
	if err != nil {
