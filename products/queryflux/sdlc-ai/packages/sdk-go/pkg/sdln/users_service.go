...
func (s *UserService) GetActivity(ctx context.Context, userID string, opts *ListOptions) (*PaginatedResponse[UserActivity], error) {
	...
	var response PaginatedResponse[UserActivity]
	err := s.doGet(ctx, path, &response)
	if err != nil {
